...
- Stabilize project, script, scene, panel, character, world, asset, style, voice, and workflow-stage save/load contracts.
...
- Additional image-generation engines are postponed because ComfyUI is sufficient for now.
