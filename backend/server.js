...
app.get('/api', (_req, res) => {
  res.json({
    ...
    modules: [
      ...
      'POST /api/projects/:projectId/assets/:assetId/versions',
      'GET  /api/projects/:projectId/assets/:assetId/storage',
      'GET  /api/projects/:projectId/assets/:assetId/relationships',
      'POST /api/projects/:projectId/assets/:assetId/relationships',
      ...
      'GET  /api/projects/:projectId/production/animation/timelines',
      'GET  /api/projects/:projectId/production/animation/timelines/:timelineId/keyframes',
